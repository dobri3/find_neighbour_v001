...
class NeighbourModel{
  ...
  required this.neighbourCost, required this.neighbourDescription});
}
...
List<NeighbourModel> neighbourModels =[
  ...
  neighbourCost: 35000, 
  neighbourDescription: """Описание:Работаю удаленно разработчиком, 
  поэтому часто нахожусь дома. Ищу спокойное жилье без шумных вечеринок. 
  В быту чистоплотный, убираю за собой. Уважаю личное пространство. 
  Из увлечений: гитара (играю тихо, в наушниках), настолки, бег по утрам. 
  Ищу соседа, с которым можно иногда пить кофе и молча работать в одной комнате, 
  но в основном — просто мирно сосуществовать. Не курю, к алкоголю отношусь 
  нейтрально."""),
  NeighbourModel(neighbourName: "Саша", 
  neighbourFullName: "Саша Александров", 
  neighbourPhoto: "asset/images/smart_guy.jpg", 
